<?php
    $obj = new database();
    $sql = "SELECT * FROM duan d LEFT JOIN nhao n ON d.maDA = n.maDA WHERE d.maDA = '$mada'";
    ...
    if($sanpham){
        ...
        if (isset($_POST["btsua"])) {
            ...
            if ($obj->suadulieu($sqlDuan)) {
                // Nếu sửa bảng `duan` thành công, tiếp tục sửa bảng `nhao`
                $sqlNhao = "UPDATE nhao 
                                SET loaiNha = '$loaiNha',
                                    soPhongNgu = '$soPN',
                                    soNhaVS = '$soNhaVS',
                ...
                if ($obj->suadulieu($sqlNhao)) {
                    echo "<script>
                        alert('Cập nhật dự án và nhà ở thành công!');
                        window.location.href = window.location.href; // Reload lại chính trang hiện tại
                    </script>";
                } else {
                    echo "<script type='text/javascript'>alert('Cập nhật nhà ở thất bại!');</script>";
                }
            } else {
                                    ...
                                    <div class="col-8 mt-3 mb-3">
                                        <div class="form-section">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" id="loaiNha" name="loaiNha">
                                                    <option <?= (!isset($sanpham[0]['loaiNha']) || $sanpham[0]['loaiNha'] == "Loại nhà ở") ? "selected" : "" ?>>Loại nhà ở</option>
                                                    <option <?= (isset($sanpham[0]['loaiNha']) && $sanpham[0]['loaiNha'] == "Nhà cấp 4") ? "selected" : "" ?>>Nhà cấp 4</option>
                                                    <option <?= (isset($sanpham[0]['loaiNha']) && $sanpham[0]['loaiNha'] == "Biệt thự") ? "selected" : "" ?>>Biệt thự</option>
                                                </select>
                                            </div>
                                        <div class="mb-3 mt-3">
                                            <label for="soPN">Số phòng ngủ:</label>
                                            <input type="text" class="form-control" id="soPN" value="<?=$sanpham[0]['soPhongNgu']?>" placeholder="Số phòng ngủ" name="soPN">
                                        </div>
                                        <div class="mb-3 mt-3">
                                            <label for="soNhaVS">Số nhà vệ sinh:</label>
                                            <input type="text" class="form-control" id="soNhaVS" value="<?=$sanpham[0]['soNhaVS']?>" placeholder="Số nhà vệ sinh" name="soNhaVS">
                                        </div>
                                        <div class="mb-3">
                                            <label for="huongCua">Hướng cửa chính:</label>
                                            <select class="form-select" id="huongCua" name="huongCua">
                                                <option <?= (!isset($sanpham[0]['huongCua']) || $sanpham[0]['huongCua'] == "Hướng cửa chính") ? "selected" : "" ?>>Hướng cửa chính</option>
                                                <option <?= (isset($sanpham[0]['huongCua']) && $sanpham[0]['huongCua'] == "Đông") ? "selected" : "" ?>>Đông</option>
                                                <option <?= (isset($sanpham[0]['huongCua']) && $sanpham[0]['huongCua'] == "Tây") ? "selected" : "" ?>>Tây</option>
                                                <option <?= (isset($sanpham[0]['huongCua']) && $sanpham[0]['huongCua'] == "Nam") ? "selected" : "" ?>>Nam</option>
                                                <option <?= (isset($sanpham[0]['huongCua']) && $sanpham[0]['huongCua'] == "Bắc") ? "selected" : "" ?>>Bắc</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="phapLy" name="phapLy">
                                                <option <?= (!isset($sanpham[0]['phapLy']) || $sanpham[0]['phapLy'] == "Giấy tờ pháp lý") ? "selected" : "" ?>>Giấy tờ pháp lý</option>
                                                <option <?= (isset($sanpham[0]['phapLy']) && $sanpham[0]['phapLy'] == "Sổ đỏ") ? "selected" : "" ?>>Sổ đỏ</option>
                                                <option <?= (isset($sanpham[0]['phapLy']) && $sanpham[0]['phapLy'] == "Sổ hồng") ? "selected" : "" ?>>Sổ hồng</option>
                                                <option <?= (isset($sanpham[0]['phapLy']) && $sanpham[0]['phapLy'] == "Giấy chứng nhận quyền sử dụng đất") ? "selected" : "" ?>>Giấy chứng nhận quyền sử dụng đất</option>
                                                <option <?= (isset($sanpham[0]['phapLy']) && $sanpham[0]['phapLy'] == "Giấy phép xây dựng") ? "selected" : "" ?>>Giấy phép xây dựng</option>
                                                <option <?= (isset($sanpham[0]['phapLy']) && $sanpham[0]['phapLy'] == "Hợp đồng mua bán") ? "selected" : "" ?>>Hợp đồng mua bán</option>
                                                <option <?= (isset($sanpham[0]['phapLy']) && $sanpham[0]['phapLy'] == "Giấy chứng nhận quyền sở hữu nhà") ? "selected" : "" ?>>Giấy chứng nhận quyền sở hữu nhà</option>
                                            </select>
                                        </div>
