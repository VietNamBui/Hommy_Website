<?php
    $obj = new database();
    $sql = "SELECT * FROM duan d LEFT JOIN chungcu cu ON d.maDA = cu.maDA WHERE d.maDA = '$mada'";
    ...
    if($sanpham){
        ...
        if (isset($_POST["btsua"])) {
            ...
            if ($obj->suadulieu($sqlDuan)) {
                // Nếu sửa bảng `duan` thành công, tiếp tục sửa bảng `chungcu`
                $sqlChungCu = "UPDATE chungcu 
                                SET soPhongNgu = '$soPN',
                                    soNhaVS = '$soNhaVS',
                                    phapLy = '$phapLy',
                                    maCan ='$maCan',
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8 mt-3 mb-3">
                                        <div class="form-section">
                                            ...
                                            <input type="text" class="form-control" id="maCan" value="<?=$sanpham[0]['maCan']?>" placeholder="Mã căn" name="maCan">
                                        </div>
                                        <div class="mb-3 mt-3">
                                            <label for="block">Block:</label>
                                            <input type="text" class="form-control" id="block" value="<?=$sanpham[0]['block']?>" placeholder="Block" name="block">
                                        </div>
