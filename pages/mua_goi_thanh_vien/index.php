    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="package-card p-4">
                ...
                <button class="btn btn-primary select-btn">Chọn Gói</button>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="package-card p-4">
                ...
                <button class="btn btn-success select-btn">Chọn Gói</button>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="package-card p-4">
                ...
                <button class="btn btn-warning select-btn">Chọn Gói</button>
            </div>
        </div>
    </div>
</div>