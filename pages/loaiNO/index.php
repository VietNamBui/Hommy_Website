                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="loaiNha" name="loaiNha" 
                                        required oninvalid="this.setCustomValidity('Vui lòng chọn loại nhà!')" oninput="setCustomValidity('')">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="soPN" placeholder="Số phòng ngủ" name="soPN" 
                                        required oninvalid="this.setCustomValidity('Vui lòng nhập số phòng ngủ!')" oninput="setCustomValidity('')">
                                </div>
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="soNhaVS" placeholder="Số nhà vệ sinh" name="soNhaVS" 
                                        required oninvalid="this.setCustomValidity('Vui lòng nhập số nhà vệ sinh!')" oninput="setCustomValidity('')">
                                </div>
                                
                                <div class="mb-3">
                                    <label for="huongCua">Hướng cửa chính:</label>
                                    <select class="form-select" id="huongCua" name="huongCua" 
                                        required oninvalid="this.setCustomValidity('Vui lòng chọn hướng cửa chính!')" oninput="setCustomValidity('')">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="phapLy" name="phapLy" 
                                        required oninvalid="this.setCustomValidity('Vui lòng chọn giấy tờ pháp lý!')" oninput="setCustomValidity('')">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="number" class="form-control" id="giaThue" placeholder="Tiền thuê" name="giaThue" 
                                        required oninvalid="this.setCustomValidity('Vui lòng nhập giá thuê!')" oninput="setCustomValidity('')">
                                </div>
