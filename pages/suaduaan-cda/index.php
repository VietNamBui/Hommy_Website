                    ...
                    <div class="container bg-light rounded-3" style="min-height: 800px;">
                        <div class="row">
                            <div class="col-4 mt-3 mb-3">
                                <h5 class="text-center"> Chỉnh sửa hình ảnh và Video sản phẩm</h5>
                            ...
                            <div class="col-8 mt-3 mb-3">
                                ...
                                <form action="">
                                    <div id="phongtroForm" class="form-section">
                                        <div class="mb-3 mt-3">
                                            <label for="tieude">Chỉnh sửa tiêu đề bài đăng:</label>
                                            <input type="text" class="form-control" id="tieude" value="Tiêu đề hiện có" name="tieude">
                                        </div>
                                        ...
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="Sonha" value="Số nhà hiện có" name="Sonha">
                                        </div>
                                        <h5>Thông tin bất động sản</h5>
                                        <div class="mb-3 mt-3">
                                            <label for="dientich">Diện tích:</label>
                                            <input type="text" class="form-control" id="dientich" value="100 m²" name="dientich">
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="furniture" name="furniture">
                                                ...
                                                <option selected>Đầy đủ nội thất</option>
                                        ...
                                        <div class="mb-3 mt-3">
                                            ...
                                            <input type="number" class="form-control" id="tiencoc" value="1000000" name="tiencoc">
                                        </div>
                                        <div class="mb-3 mt-3">
                                            <label for="tienthue">Tiền thuê:</label>
                                            <input type="number" class="form-control" id="tienthue" value="5000000" name="tienthue">
                                        </div>
                                        <div class="mb-3 mt-3">
