            ...
            <div class="mt-2 p-2 bg-light rounded">
                ...
                <div id="projectsCarousel" class="carousel slide mt-5" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        ...
                        $totalItems = count($duan); // Tổng số dự án
                        $itemsPerPage = 6; // Số dự án mỗi trang
                        $numPages = ceil($totalItems / $itemsPerPage); // Số lượng trang cần thiết

                        for ($page = 0; $page < $numPages; $page++) {
                            // Xác định nếu là trang đầu tiên thì thêm class "active"
                            $activeClass = $page === 0 ? "active" : "";
